...
export const LazyDiwaliTemplate = dynamic(
    () =>
        import("@/components/greetings/DiwaliTemplate").then(
            (mod) => ({ default: mod.DiwaliTemplate }),
        ),
    {
...
export const LazyNewYearTemplate = dynamic(
    () =>
        import("@/components/greetings/NewYearTemplate").then(
            (mod) => ({ default: mod.NewYearTemplate }),
        ),
    {
        loading: AnimationLoading,
        ssr: false,
...
export const LazyPongalTemplate = dynamic(
    () =>
        import("@/components/greetings/PongalTemplate").then(
            (mod) => ({ default: mod.PongalTemplate }),
        ),
    {
        loading: AnimationLoading,
        ssr: false,
...
export const LazyChristmasTemplate = dynamic(
    () =>
        import("@/components/greetings/ChristmasTemplate").then(
            (mod) => ({ default: mod.ChristmasTemplate }),
        ),
    {
        loading: AnimationLoading,
        ssr: false,
...
export const LazyHoliTemplate = dynamic(
    () =>
        import("@/components/greetings/HoliTemplate").then(
            (mod) => ({ default: mod.HoliTemplate }),
        ),
    {
        loading: AnimationLoading,
        ssr: false,
...
export const LazyGenericTemplate = dynamic(
    () =>
        import("@/components/greetings/GenericTemplate").then(
            (mod) => ({ default: mod.GenericTemplate }),
        ),
    {
        loading: AnimationLoading,
        ssr: false,
...
export function preloadAllTemplates(): void {
    ...
    schedulePreload(() => (LazyDiwaliTemplate as { preload?: () => void }).preload?.());
    schedulePreload(() => (LazyNewYearTemplate as { preload?: () => void }).preload?.());
    schedulePreload(() => (LazyPongalTemplate as { preload?: () => void }).preload?.());
    schedulePreload(() => (LazyChristmasTemplate as { preload?: () => void }).preload?.());
    schedulePreload(() => (LazyHoliTemplate as { preload?: () => void }).preload?.());
    schedulePreload(() => (LazyGenericTemplate as { preload?: () => void }).preload?.());
}
