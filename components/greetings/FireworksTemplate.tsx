...
export const FireworksTemplate = memo(FireworksTemplateComponent, (prevProps, nextProps) => {
  return (
    ...
    JSON.stringify(prevProps.colorPalette) === JSON.stringify(nextProps.colorPalette)
  );
});
