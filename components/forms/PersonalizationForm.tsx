...
export function PersonalizationForm() {
  ...
  const onSubmit = async (data: PersonalizationFormData) => {
    ...
    sessionStorage.setItem("greeting_recipientName", data.recipientName);
    sessionStorage.setItem("greeting_senderName", data.senderName);
    sessionStorage.setItem("greeting_customMessage", data.customMessage || "");
